...
submitButton.disabled = true;
  ...
  if (result.success) {
    document.getElementById('formMessage').textContent = '✅ Submission successful! Thank you for entering the contest. Come back to vote when submissions close at . Refresh the page to submit another entry.';
    form.reset();
  } else {
